...
// ══════════════════════════════════════════════
const CONFIG = {
  gameDuration: 70, maxLives: 5, lanes: 5,
  baseSpeed: 0.7, maxSpeed: 1.6,
  spawnInterval: 1200, minSpawnInterval: 700,
  maxItemsOnScreen: 8, minItemsOnScreen: 6,
  collectChance: 0.6, scorePerCollect: 100,
  ...
  themes: {
    boss: {
      canvasBg: '#fdf2f8',
      tint1: 'rgba(236,72,153,0.30)', tint2: 'rgba(190,24,93,0.12)',
      laneEdge: 'rgba(236,72,153,0.20)', laneInner: 'rgba(236,72,153,0.05)',
      collectGlow: [236,72,153], obstacleGlow: [190,24,93],
      playerGlow: [236,72,153], scratchA: '#ec4899', scratchB: '#be185d',
      hudTimer: '#ec4899', hudScore: '#ec4899',
      collectFill: 'rgba(252,231,243,0.65)', obstacleFill: 'rgba(255,228,230,0.65)',
    },
    idol: {
      canvasBg: '#faf5ff',
      tint1: 'rgba(168,85,247,0.28)', tint2: 'rgba(124,58,237,0.12)',
      laneEdge: 'rgba(168,85,247,0.20)', laneInner: 'rgba(168,85,247,0.05)',
      collectGlow: [168,85,247], obstacleGlow: [124,58,237],
      playerGlow: [168,85,247], scratchA: '#a855f7', scratchB: '#7c3aed',
      hudTimer: '#a855f7', hudScore: '#a855f7',
      collectFill: 'rgba(243,232,255,0.65)', obstacleFill: 'rgba(237,223,252,0.65)',
    },
    doctor: {
      canvasBg: '#eef2ff',
      tint1: 'rgba(99,102,241,0.22)', tint2: 'rgba(79,70,229,0.12)',
      laneEdge: 'rgba(99,102,241,0.20)', laneInner: 'rgba(99,102,241,0.05)',
      collectGlow: [99,102,241], obstacleGlow: [79,70,229],
      playerGlow: [99,102,241], scratchA: '#6366f1', scratchB: '#4f46e5',
      hudTimer: '#6366f1', hudScore: '#6366f1',
      collectFill: 'rgba(224,231,255,0.65)', obstacleFill: 'rgba(219,224,255,0.65)',
    },
    baker: {
      canvasBg: '#fffbeb',
      tint1: 'rgba(217,119,6,0.18)', tint2: 'rgba(245,158,11,0.12)',
      laneEdge: 'rgba(217,119,6,0.18)', laneInner: 'rgba(217,119,6,0.05)',
      collectGlow: [217,119,6], obstacleGlow: [180,83,9],
      playerGlow: [245,158,11], scratchA: '#d97706', scratchB: '#b45309',
      hudTimer: '#d97706', hudScore: '#d97706',
      collectFill: 'rgba(254,243,199,0.65)', obstacleFill: 'rgba(254,236,164,0.65)',
    },
    swat: {
      canvasBg: '#fff1f2',
      tint1: 'rgba(225,29,72,0.22)', tint2: 'rgba(190,18,60,0.12)',
      laneEdge: 'rgba(225,29,72,0.20)', laneInner: 'rgba(225,29,72,0.05)',
      collectGlow: [225,29,72], obstacleGlow: [190,18,60],
      playerGlow: [225,29,72], scratchA: '#e11d48', scratchB: '#be123c',
      hudTimer: '#e11d48', hudScore: '#e11d48',
      collectFill: 'rgba(255,228,230,0.65)', obstacleFill: 'rgba(255,216,220,0.65)',
    },
  },
  ...
  characters: [
    { id:'boss',name:'霸总',emoji:'🖤',color:'#ec4899',colorLight:'#fce7f3',image:'',
      desc:'冷硬外壳下藏着只对你的温柔',cardQuote:'"上车。我只说一次。"',
      unlockDialogue:'"……我不太会说那种话。<br>但如果你愿意留下来，<br>我每天都会来接你。"',
      collectibles:[{name:'替你挡酒',text:'"她不喝。剩下的我来。"'},{name:'专属接送',text:'"不管几点，打我电话。"'},{name:'定制礼物',text:'没有logo的盒子，尺寸刚好是你的手腕。'},{name:'包下餐厅',text:'"今晚这里只有我们。"'},{name:'主动道歉',text:'"……是我不对。"'}],
      obstacles:[{name:'冷言拒绝',text:'"别闹了。"'},{name:'故意疏远',text:'他的已读，停在了三小时前。'},{name:'说你幼稚',text:'"你能不能成熟一点？"'},{name:'漠不关心',text:'满桌的文件，连抬头都没有。'},{name:'语气刻薄',text:'"你以为我很闲？"'}] },
    { id:'idol',name:'Idol',emoji:'💜',color:'#a855f7',colorLight:'#f3e8ff',image:'',
      desc:'聚光灯下万人迷，只偷偷见你',cardQuote:'"我总是知道你在哪里。"',
      unlockDialogue:'"我站在台上的时候，灯光太亮，<br>看不见任何人的脸。<br>但我总是知道你在哪里。"',
      collectibles:[{name:'专属唱给你',text:'彩排时他对着空座位唱了一首歌。'},{name:'偷偷见你',text:'"好久不见。"'},{name:'公开护你',text:'"她是很重要的人，请不要打扰她。"'},{name:'雨天共撑',text:'他的肩湿了大半。'},{name:'陪你看海',text:'"至少在海边，我只是我。"'}],
      obstacles:[{name:'隐瞒关系',text:'"我们……不能让别人知道。"'},{name:'公开避嫌',text:'擦肩而过时眼神空白得像陌生人。'},{name:'忽冷忽热',text:'昨天的温柔像一场梦。'},{name:'深夜失联',text:'电话那头只有忙音。'},{name:'敷衍回应',text:'"嗯。" "好。" "再说吧。"'}] },
    { id:'doctor',name:'医生',emoji:'💙',color:'#6366f1',colorLight:'#e0e7ff',image:'',
      desc:'白大褂下一颗为你跳动的心',cardQuote:'"有一种心跳，不需要治。"',
      unlockDialogue:'"我习惯了治别人的病。<br>但遇到你之后，我才知道<br>有一种心跳加速，不需要治。"',
      collectibles:[{name:'熬养胃汤',text:'"先喝汤，别空腹吃药。"'},{name:'记得你忌口',text:'"她不吃香菜。换一份。"'},{name:'递暖手宝',text:'什么也没说，只是把暖手宝塞进你手心。'},{name:'帮你贴药',text:'创口贴上画了个笑脸。'},{name:'温柔叮嘱',text:'"早睡。我知道你不听，但我每天都会说。"'}],
      obstacles:[{name:'深夜加班',text:'"对不起，今晚又回不去了。"'},{name:'拒谈心事',text:'"我没事。"——连续工作36小时。'},{name:'爽约急诊',text:'"……我得走了。"'},{name:'无暇陪伴',text:'"手术还没结束，蛋糕在冰箱里。"'},{name:'刻意回避',text:'眼神温柔，但转身的速度更快。'}] },
    { id:'baker',name:'甜品师',emoji:'🧡',color:'#d97706',colorLight:'#fef3c7',image:'',
      desc:'用甜蜜融化所有不安',cardQuote:'"你的表情我全记得。"',
      unlockDialogue:'"我这辈子做过最好吃的东西，<br>是你笑着说好吃的那一个。<br>配方我没记下来，但你的表情我全记得。"',
      collectibles:[{name:'定制甜品',text:'"今天也很喜欢你。"'},{name:'教你烘焙',text:'"你比奶油还甜。"'},{name:'甜品告白',text:'马卡龙夹心里藏了一张纸条。'},{name:'清晨送甜',text:'"刚出炉的。今天也要开心。"'},{name:'喂你吃甜',text:'吹了吹勺子上的布丁，递到你嘴边。'}],
      obstacles:[{name:'沉默不语',text:'揉面的手没有停，但他在想别的事。'},{name:'忘记喜好',text:'"你……不喜欢草莓的吗？"'},{name:'拒你靠近',text:'"现在不行。"——眼神分明不是在说面粉。'},{name:'无意刺痛',text:'"做甜品嘛，对谁都一样的。"'},{name:'不愿坦诚',text:'"没什么。"他关上了烤箱，也关上了话题。'}] },
    { id:'swat',name:'特警',emoji:'❤️',color:'#e11d48',colorLight:'#ffe4e6',image:'',
      desc:'铁血柔情，笨拙却奋不顾身',cardQuote:'"那个方向变得很具体。"',
      unlockDialogue:'"我不怕出任务。<br>但每次出发之前，我会站在门口多看一眼家的方向。<br>自从遇见你，那个方向变得很具体。"',
      collectibles:[{name:'护你周全',text:'他把你拉到了身后。自然得像呼吸。'},{name:'挡掉危险',text:'"没事了。"'},{name:'粗中有细',text:'桌上多了药、热水和一张写歪的纸条。'},{name:'危急奔赴',text:'十五分钟后他出现了，气喘吁吁。'},{name:'笨拙浪漫',text:'"……这个，超市买的。不贵。"'}],
      obstacles:[{name:'临时出警',text:'"等我一下。"——这一下是八个小时。'},{name:'失踪失联',text:'整整两天没有消息。'},{name:'隐瞒任务',text:'"……出差。"他身上有消毒水的味道。'},{name:'约会爽约',text:'你在餐厅等到打烊。'},{name:'刻意疏远',text:'"别离我太近。"'}] },
  ],
};
...
function loadProgress() {
  try { const d = JSON.parse(localStorage.getItem('dateGame_v3')); if (d) state.progress = d; } catch(e) {}
...
function typeWriter(el, html, speed, callback) {
  ...
  twTimer = setInterval(() => {
    ...
    built += tok.val;
    idx++;
    // Batch: if next tokens are tags, add them too (tags appear instantly)
    while (idx < tokens.length && tokens[idx].type === 'tag') {
      built += tokens[idx].val;
      idx++;
    }
...
let currentSkip = null; // stores the skip function for current typewriter
...
function initSelectScreen() {
  ...
  CONFIG.characters.forEach((ch, i) => {
    ...
    card.innerHTML = `<div class="select-avatar"><div class="select-avatar-inner">${ch.emoji}</div></div><div class="select-name">${ch.name}</div><div class="select-stars">${stars}</div>`;
...
function startNarrative() {
  ...
  // 按钮初始状态
  narrativeTypingDone = false;
  document.getElementById('btnNarSkip').textContent = '跳过 →';
  ...
  setTimeout(() => {
    ...
    currentSkip = typeWriter(el, nar.intro, 55, () => {
      narrativeTypingDone = true;
      document.getElementById('btnNarSkip').textContent = '开始游戏 →';
      currentSkip = null;
    });
  }, 450);
}
...
function onNarrativeAction() {
  if (!narrativeTypingDone && currentSkip) {
    // 正在打字 → 跳过，立即显示全文
    currentSkip();
  } else {
    // 打字完成 → 开始游戏
...
class GameEngine {
  constructor() {
    ...
    this.theme = CONFIG.themes[this.char.id];
    ...
    this.running = false;
    this.paused = false;
    this.lastSpawn = 0; this.lastTime = 0; this.elapsed = 0;
    this.shakeAmount = 0;
    this.W = 0; this.H = 0;
  ...
  resize() {
    ...
    this.playerSize = Math.min(24, this.laneW*0.36);
  }

  start() { this.resize(); this.running=true; this.paused=false; this.lastTime=performance.now(); this.updateHUD(); this.loop(performance.now()); }
  stop() { this.running=false; }
  pause() { this.paused=true; }
  resume() { this.paused=false; this.lastTime=performance.now(); this.loop(performance.now()); }

  loop(now) {
    if(!this.running||this.paused)return;
    const dt=Math.min((now-this.lastTime)/1000,0.05);
    this.lastTime=now; this.elapsed+=dt; this.time-=dt;
    ...
    const active=this.items.filter(i=>!i.hit).length;
    const interval=active<CONFIG.minItemsOnScreen?spawnInt*0.4:spawnInt;
    if(now-this.lastSpawn>interval&&active<CONFIG.maxItemsOnScreen){this.spawnItem();this.lastSpawn=now;}
    this.update(dt,progress); this.render(); this.updateHUD();
  ...
  update(dt,progress) {
    ...
    for(let i=this.items.length-1;i>=0;i--){
      const item=this.items[i]; item.y+=speedPx;
      if(!item.hit){
        const ix=item.lane*this.laneW+this.laneW/2;
        const dist=Math.sqrt((ix-this.playerX)**2+(item.y-this.playerY)**2);
        if(dist<this.itemRadius+this.playerSize){
          item.hit=true;
          if(item.type==='collect'){this.score+=CONFIG.scorePerCollect;this.addFloat(ix,item.y,item.text,'collect');this.flashCollect();}
          else{this.lives--;this.addFloat(ix,item.y,item.text,'obstacle');this.flashHit();this.shakeAmount=6;if(this.lives<=0){this.endGame();return;}}
        }
      }
  ...
  render() {
    ...
    g1.addColorStop(0,t.tint1); g1.addColorStop(1,'transparent');
    ctx.fillStyle=g1; ctx.fillRect(0,0,w,h);
    const g2=ctx.createRadialGradient(w*.7,h*.6,10,w*.7,h*.6,w*.5);
    g2.addColorStop(0,t.tint2); g2.addColorStop(1,'transparent');
    ...
    for(let i=0;i<=CONFIG.lanes;i++){
      ...
      for(let y=0;y<h;y+=3){const x=i*this.laneW+Math.sin(y*0.04+i)*1.2;y===0?ctx.moveTo(x,y):ctx.lineTo(x,y);}
      ctx.strokeStyle=edge?t.laneEdge:t.laneInner;
      ctx.lineWidth=edge?1.2:0.5; ctx.stroke();
    }
    ctx.globalAlpha=0.03;
    for(let i=0;i<4;i++){
      const s=i*137.5;
      ctx.beginPath();ctx.moveTo((s*3.1)%(w*.4),(s*7.3)%h);ctx.lineTo((s*3.1)%(w*.4)+40+(s%60),(s*7.3)%h+((s*.7)%4)-2);
      ctx.strokeStyle=i%2===0?t.scratchA:t.scratchB;ctx.lineWidth=.5;ctx.stroke();
    }
    ctx.globalAlpha=1;
    ...
    this.items.forEach(item=>{
      ...
      const gc=isC?t.collectGlow:t.obstacleGlow;
      const glow=ctx.createRadialGradient(ix,iy,r*0.5,ix,iy,r*2.86);
      glow.addColorStop(0,`rgba(${gc[0]},${gc[1]},${gc[2]},0.24)`);
      glow.addColorStop(0.5,`rgba(${gc[0]},${gc[1]},${gc[2]},0.08)`);
      glow.addColorStop(1,'transparent');
      ctx.fillStyle=glow;ctx.beginPath();ctx.arc(ix,iy,r*2.86,0,Math.PI*2);ctx.fill();
      ctx.beginPath();ctx.arc(ix,iy,r,0,Math.PI*2);
      ctx.fillStyle=isC?t.collectFill:t.obstacleFill;ctx.fill();
      ctx.beginPath();ctx.arc(ix,iy,r+2,0,Math.PI*2);
      ctx.strokeStyle=`rgba(${gc[0]},${gc[1]},${gc[2]},0.16)`;ctx.lineWidth=4;ctx.stroke();
      ctx.beginPath();ctx.arc(ix,iy,r,0,Math.PI*2);
      ctx.strokeStyle=`rgba(${gc[0]},${gc[1]},${gc[2]},0.45)`;ctx.lineWidth=1.5;ctx.stroke();
      ctx.font=`${r*0.95}px sans-serif`;ctx.textAlign='center';ctx.textBaseline='middle';
      ctx.fillText(isC?'💗':'💔',ix,iy);
      ctx.fillStyle=`rgba(${gc[0]},${gc[1]},${gc[2]},0.7)`;
    ...
    const pc=t.playerGlow;
    const pg=ctx.createRadialGradient(px,py,ps*0.4,px,py,ps*3.64);
    pg.addColorStop(0,`rgba(${pc[0]},${pc[1]},${pc[2]},0.24)`);
    pg.addColorStop(0.5,`rgba(${pc[0]},${pc[1]},${pc[2]},0.08)`);
    pg.addColorStop(1,'transparent');
    ctx.fillStyle=pg;ctx.beginPath();ctx.arc(px,py,ps*3.64,0,Math.PI*2);ctx.fill();
    ctx.beginPath();ctx.arc(px,py,ps,0,Math.PI*2);ctx.fillStyle='rgba(252,231,243,0.7)';ctx.fill();
    ctx.beginPath();ctx.arc(px,py,ps+2,0,Math.PI*2);
    ctx.strokeStyle=`rgba(${pc[0]},${pc[1]},${pc[2]},0.15)`;ctx.lineWidth=4;ctx.stroke();
    ctx.beginPath();ctx.arc(px,py,ps,0,Math.PI*2);
    ctx.strokeStyle=`rgba(${pc[0]},${pc[1]},${pc[2]},0.45)`;ctx.lineWidth=1.5;ctx.stroke();
    ...
    if(Math.sin(gt*2.7)>0.85){
      ctx.fillStyle=`rgba(${pc[0]},${pc[1]},${pc[2]},0.06)`;
  ...
  addFloat(x,y,text,type){
    ...
    el.style.left=(rect.left+(x/this.W)*rect.width)+'px';el.style.top=(rect.top+(y/this.H)*rect.height)+'px';
    document.body.appendChild(el);setTimeout(()=>el.remove(),1600);
  }
  flashHit(){const e=document.createElement('div');e.className='hit-flash';document.getElementById('canvasWrap').appendChild(e);setTimeout(()=>e.remove(),350);}
  flashCollect(){const e=document.createElement('div');e.className='collect-flash';document.getElementById('canvasWrap').appendChild(e);setTimeout(()=>e.remove(),350);}

  updateHUD(){
    let lh='';for(let i=0;i<CONFIG.maxLives;i++)lh+=`<span class="life${i>=this.lives?' lost':''}">★</span>`;
    document.getElementById('hudLives').innerHTML=lh;
    document.getElementById('hudCharName').textContent=this.char.name+'线';
    const te=document.getElementById('hudTimer');te.textContent=Math.ceil(this.time);
    te.className='hud-timer '+(this.time<=10?'warning':'normal');
    te.style.color=this.time<=10?'var(--rose)':this.theme.hudTimer;
    document.getElementById('hudScore').textContent=this.score;
    document.getElementById('hudScore').style.color=this.theme.hudScore;
  }

  endGame(){this.running=false;showResult(this.score);}
  movePlayer(dir){if(!this.running)return;this.playerTargetLane=Math.max(0,Math.min(CONFIG.lanes-1,this.playerTargetLane+dir));}
}

// ══════════════════════════════════════════════
// INPUT
// ══════════════════════════════════════════════
document.addEventListener('keydown',e=>{if(!game||!game.running)return;if(e.key==='ArrowLeft'||e.key==='a')game.movePlayer(-1);if(e.key==='ArrowRight'||e.key==='d')game.movePlayer(1);});
...
document.addEventListener('touchend',e=>{if(!game||!game.running)return;const dx=e.changedTouches[0].clientX-touchX,dy=e.changedTouches[0].clientY-touchY;if(Math.abs(dx)>20&&Math.abs(dx)>Math.abs(dy))game.movePlayer(dx>0?1:-1);else if(Math.abs(dx)<10&&Math.abs(dy)<10)game.movePlayer(e.changedTouches[0].clientX<window.innerWidth/2?-1:1);},{passive:true});
...
// ══════════════════════════════════════════════
// CARD ACQUIRE ANIMATION — 获得卡牌星动效
// ══════════════════════════════════════════════
...
function showUnlock(ch) {
  document.getElementById('unlockCard').innerHTML = `
    <div class="uc-top" style="background:radial-gradient(ellipse at 50% 40%,${ch.colorLight},transparent 80%);">
      <svg width="80" height="110" viewBox="0 0 80 120">
        <defs><linearGradient id="ucg" x1="0" y1="0" x2="1" y2="1">
          <stop offset="0%" stop-color="${ch.color}" stop-opacity=".5"/>
          <stop offset="100%" stop-color="${ch.color}" stop-opacity=".25"/>
        </linearGradient></defs>
        <circle cx="40" cy="28" r="16" fill="url(#ucg)"/>
        <path d="M20 54Q28 42 40 40Q52 42 60 54L64 112Q40 120 16 112Z" fill="url(#ucg)"/>
      </svg>
    </div>
    <div class="uc-info">
  ...
  CONFIG.characters.forEach(ch => {
    ...
    card.innerHTML = `
      <div class="cc-top" style="background:radial-gradient(ellipse at 50% 40%,${ch.colorLight},transparent 80%);">
        <svg width="60" height="90" viewBox="0 0 80 120">
          <defs><linearGradient id="ccg${ch.id}" x1="0" y1="0" x2="1" y2="1">
            <stop offset="0%" stop-color="${ch.color}" stop-opacity=".45"/>
            <stop offset="100%" stop-color="${ch.color}" stop-opacity=".2"/>
          </linearGradient></defs>
          <circle cx="40" cy="28" r="16" fill="url(#ccg${ch.id})"/>
          <path d="M20 54Q28 42 40 40Q52 42 60 54L64 112Q40 120 16 112Z" fill="url(#ccg${ch.id})"/>
        </svg>
      </div>
      <div class="cc-info">
